...
figure(1)
theta1 = 115*dtr;
thetaR2 = 150*dtr;thetaR3 = 90*dtr;thetaR4 = 200*dtr;thetaR5 =100*dtr;thetaR6 = 0;
...
saveas(figure(1),'home.png')

%% Animate
counter = 1;
%Joint Animation
%{
for theta1=dtr*(115:-0.5:105)
    figure(2)
    T_1 = eval(T_R(:,:,1));L1.vertices = (T_1(1:3,1:3)*L1_o.vertices'+T_1(1:3,4))';
    T_R2 = eval(T_R(:,:,2));LR2.vertices = (T_R2(1:3,1:3)*LR2_o.vertices'+T_R2(1:3,4))';
    T_R3 = eval(T_R(:,:,3));LR3.vertices = (T_R3(1:3,1:3)*LR3_o.vertices'+T_R3(1:3,4))';
    ...
    fileName = ['Joint' num2str(counter) '.png'];
    saveas(figure(2),fileName);
    counter=counter+1;
end
for theta1=dtr*(105:0.5:125)
    figure(2)
